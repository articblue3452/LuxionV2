...
def llm_answer(question: str, research: str = "") -> str:
    """Produce a concise answer from a question and optional research context."""
    if not isinstance(question, str) or not question.strip():
        raise ValueError("llm_answer requires a non-empty question.")
...
# Legacy public API. Existing callers can continue importing ``explain``.
explain = llm_answer
